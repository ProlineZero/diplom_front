  ...
  return (
    <>
      ...
      <div className="container w-1/2 space-y-3 fixed inline-block text-left left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
        ...
        <button type="button" className="w-full px-2 py-1 transition ease-in duration-200 uppercase rounded-full bg-red-100 text-red-500 border-red-100 hover:bg-red-200 hover:border-red-200 border-2 focus:outline-none "
