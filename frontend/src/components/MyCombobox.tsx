      ...
      <Combobox value={selected} onChange={setSelected} nullable disabled = {!isActive} >
        <div className="relative mt-2 ">
          <div className="relative cursor-default overflow-hidden rounded-xl bg-white text-left shadow-md " >
            <Combobox.Input
              className="w-full rounded-xl py-2 pl-3 pr-10 text-sm leading-5 text-gray-900 border-2 focus:outline-none focus:border-green-600 hover:border-green-600 " 
          ...
          <Transition
            ...
            afterLeave={() => setQuery('')}
          >
            <Combobox.Options  className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base text-left shadow-lg ring-1 ring-green-700 ring-opacity-5 focus:outline-none sm:text-sm">
