...
export function Navigation() {
  return (
    ...
    <div className="fixed bg-gray-200 h-full w-1/6">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-around">
            <div className="w-full h-full">
                ...
                <nav className="mt-10 px-6 ">
                    <a className="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors   duration-200  text-gray-600   " href="#">
                    ...
                    <a className="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors   duration-200 border-r-2 border-gray-600  text-gray-800   bg-gray-100 " href="#">
                        <svg width="20" height="20" fill="currentColor" className="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
